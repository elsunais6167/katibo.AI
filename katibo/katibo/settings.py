"""
Django settings for katibo project.
...
SECRET_KEY = 'rb@ivtk@v$v!-i9_a+5jj%%xro!r86n#nc%9xj-p6a26f*nj2='
...
WSGI_APPLICATION = 'katibo.wsgi.application'
